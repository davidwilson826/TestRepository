...
string1 = "aqaccb" #input("Enter first string? ")
string2 = "eqeccb" #input("Enter second string? ")
    ...
    for y in s2l:
        if x[1] == y[1]:
            ...
            while clist1[charnum][1] == clist2[charnum][1] and len(clist1)-1 > charnum and len(clist2)-1 > charnum:
                ...
                charnum += 1
            if len(clist1)-1 <= charnum:
                if clist1[-1] == clist2[charnum]:
                    currcstring += clist2[charnum][1]
            elif len(clist2)-1 <= charnum:
                if clist2[-1] == clist1[charnum]:
                    currcstring += clist1[charnum][1]
